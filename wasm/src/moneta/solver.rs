use crate::moneta::constraints::{check_hard_constraints, get_default_soft_constraints};
use crate::moneta::types::{MonetaFacts, MonetaSpec, SolverResult, VRBehavior, VRGeometry, VRInteraction, VRLayout};

pub fn generate_all_candidates() -> Vec<MonetaSpec> {
...
pub fn solve_moneta(facts: MonetaFacts) -> Option<SolverResult> {
...
mod tests {
    ...
    fn solver_produces_valid_spec_for_tabular() {
        ...
        let result = solve_moneta(facts).expect("Solver should produce a result");
