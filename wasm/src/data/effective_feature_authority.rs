...
pub fn numeric_linear_rank_artifact(
    ...
    if dataset_fingerprint.trim().is_empty() {
        refusal.push("MISSING_DATASET_IDENTITY".into());
    }
...
mod tests {
    ...
    #[test]
    fn malformed_empty_or_unidentified_evidence_abstains() {
        ...
        let empty_rows = numeric_linear_rank_artifact(
            "fp",
            vec!["a".into()],
            &[],
            "NUMERIC_LINEAR_RANK_DIAGNOSTIC",
        ...
        let empty_features = numeric_linear_rank_artifact(
            "fp",
            vec![],
            &[vec![]],
            "NUMERIC_LINEAR_RANK_DIAGNOSTIC",
        ...
        let missing_identity = numeric_linear_rank_artifact(
            "",
            vec!["a".into()],
            &[vec![1.0]],
            "NUMERIC_LINEAR_RANK_DIAGNOSTIC",
        );
        assert!(missing_identity.refusal_reasons.contains(&"MISSING_DATASET_IDENTITY".into()));
    }
