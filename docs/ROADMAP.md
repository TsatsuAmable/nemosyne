...
**Current main at the start of the latest review pass:** `073bb03` (#415). #418 (P1-C review exit RF-019/RF-020/RF-021 topology + adversarial fixes) is in CI. Earlier merged: #410 (P1-C sparse topology), #411 (P1-D perceptual fitness), #412 (P1-F semantic target/focus-context), #413 (P1-E actionable-NIL), #414 (P1-B async runtime production wiring), #415 (nemosyne-data corpus connector). Neighbourhood RF-017/RF-018/RF-021 fixes (farthest-point sampling, validity normalization, d>6 ExactIndex fallback) landed in the neighbourhood.rs commit preceding #418.
