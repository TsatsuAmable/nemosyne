...
## Status snapshot - 16 September 2026

**Current integration base for this planning update:** `main@cc1807d294090e724700578ca2312a24e50450a6` (#753). Stream A remains closed. Stream B's first selected structural family, source-authoritative Relationship Graph V1, remains `VERIFIED COMPLETE / STOP`. Stream C's bounded C1-C4 software path remains landed, with physical XR fitness still an empirical qualification boundary. PT0-PT8 remain landed at their bounded exits. P1-UXR remains the active pre-PT9 product-development programme: UXR0's bounded software contract and UXR1's canonical UI migration are landed, but #745 has been reopened because #746's capability guide did not satisfy the human purpose/comprehension closure criterion. The current bounded fix-forward extends GUIDE with purpose, mental-model and context-sensitive next-step orientation under a new treatment identity; physical owner comprehension remains a required closure gate. After that software tranche, the forward engineering frontier returns to the UXR2 resource lifecycle governor at its UXR3 bounded-semantic-working-set seam, followed by UXR4/UXR5 evidence. PT9 Moneta learning evidence, PT10 private-preview learning, and post-PT9 compositional/full-Moneta work remain downstream. Experimental Full-Moneta work may be preserved off the integration path but may not jump those prerequisites.
...
- UXR1's canonical UIKit and reachability software migration landed through #716, #720-#728, #734-#744 and #746: the active panels moved off the legacy `MovablePanel` substrate, VRMenu was retired, the generic panel launcher left the normal analyst path, and contextual capability guidance landed. #745 is nevertheless reopened: the reported user still lacked confidence in what Nemosyne is for and how to discover meaningful next actions. The active UXR1 human-comprehension fix-forward adds purpose/mental-model/next-step orientation but cannot close #745 without fresh physical human evidence. The retained superuser diagnostic launcher and the physical-input/human-utility residuals prevent a physical or human completion claim.
  ...
  -> Stream B Relationship Graph V1 STOP
    -> Stream C bounded C1-C4 implementation/evidence LANDED
      -> P1-PT PT0-PT8 LANDED / bounded STOP where declared
        -> P1-UXR ACTIVE (UXR1 purpose/comprehension fix-forward; then UXR2/UXR3)
...
| UXR1 | **SOFTWARE MIGRATION LANDED / PURPOSE-COMPREHENSION FIX-FORWARD ACTIVE / PHYSICAL VALIDATION OPEN** | #716, #720-#728, #734-#744 and #746 migrate the canonical panels/navigation to UIKit and semantic/contextual surfaces. #745 is reopened because capability reachability did not prove that a human understands Nemosyne's purpose, representation mental model or meaningful next action. The active treatment-v3 fix-forward addresses that software gap; fresh governed Quest human evidence remains required before the reported defect can close. |
