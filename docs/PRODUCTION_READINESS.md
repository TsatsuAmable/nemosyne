...
| RDO-009 | production-live-source-contract | AUTOMATED | GREEN | `dev/demo-stream-server.ts` | Keep /__demo-stream explicitly classified as a development fixture rather than a production service claim. |
