 ...
 */
export class DataCard implements Updatable {
  ...
  show(position: THREE.Vector3, data: Record<string, unknown>, title = 'DATA NODE'): void {
  ...
  render(data: Record<string, unknown>, title: string): void {
    const ctx = this.ctx;
