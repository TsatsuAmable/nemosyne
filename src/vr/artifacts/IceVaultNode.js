 ...
 */
export class IceVaultNode {
  constructor({ position = [0, 1.5, -3], color = 0xff0033, emissive = 0x550011, scale = 1 } = {}) {
  ...
  setEncoding({ color, emissive, coreColor, pulseSpeed = 5, rotationSpeed = 1 } = {}) {
