 ...
 * surfaces exercised by the canonical B3 journey. It is deliberately not an
 * exhaustive catalogue of developer-only diagnostics or every hidden panel in
 * the application. B4/B5 and later P1-UV tranches diff against this bounded
 * baseline so visible-product claims stay falsifiable.
 *
 ...
 * WorldUIManager surfaces so newly added boot surfaces cannot silently escape
 * this baseline.
 */
...
export const UV0_INVENTORY: readonly Uv0SurfaceEntry[] = [
  ...
  },
  {
    ...
    referenceFrame: 'BODY_LOCKED',
    summonDismiss: 'Eagerly constructed and attached at boot; no constructor-time hide is applied.',
    owningState: 'System settings / comfort / accessibility state.',
    classification: 'CONVERGE',
    rationale: 'Independent B3 review found this boot-visible SpatialPanel was omitted from the original 23-surface baseline.',
    visibleAtBoot: true,
  },
  {
    id: 'chart-plane',
