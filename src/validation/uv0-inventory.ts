...
export const UV0_INVENTORY: readonly Uv0SurfaceEntry[] = [
  ...
  },
  {
    ...
    referenceFrame: 'BODY_LOCKED',
    summonDismiss: 'Visible at boot in far tier; semantic wheel / direct panel action.',
  ...
  },
  {
    ...
    referenceFrame: 'BODY_LOCKED',
    summonDismiss: 'Visible at boot; semantic wheel / direct panel action.',
  ...
  },
  {
    ...
    referenceFrame: 'BODY_LOCKED',
    summonDismiss: 'Visible at boot; semantic wheel action.',
  ...
  {
    id: 'focused-data-sources',
    name: 'DataSourcePanel (focused data acquisition)',
    source: 'src/vr/coordinators/WorldUIManager.ts:249',
    purpose: 'Focused in-headset access to curated live sources, built-in examples, and governed approved datasets.',
    referenceFrame: 'BODY_LOCKED',
    summonDismiss: 'Hidden at boot; available from DATA → Data Sources when direct source/library selection is needed.',
    owningState: 'Data-source selection status only; loading and ingestion remain governed by existing callbacks/bridges.',
    classification: 'KEEP',
    rationale: 'Replaces the unique data-acquisition capabilities of the retired VRMenu without duplicating analysis/navigation commands.',
    visibleAtBoot: false,
  },
  {
